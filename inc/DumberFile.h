...
class TDumberFile {
 ...
 public:
  ...
  static TDumberFile* NewL(RFs &aFs, const TDesC& aFileName, TDumberOpenMode aMode);
  static TDumberFile* NewLC(RFs &aFs, const TDesC& aFileName, TDumberOpenMode aMode);
